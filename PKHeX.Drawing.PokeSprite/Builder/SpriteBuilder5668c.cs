...
public sealed class SpriteBuilder5668c : SpriteBuilder
{
    ...
    protected override string GetSpriteAllSecondary(ushort species, byte form, byte gender, uint formarg, bool shiny, EntityContext context) => (species > (ushort)Species.Enamorus ? 'a' : 'b') + SpriteName.GetResourceStringSprite(species, form, gender, formarg, context, shiny);
